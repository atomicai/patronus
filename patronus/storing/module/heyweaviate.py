...
from patronus.etc import Document, Label
from patronus.processing import get_batches_from_generator
from patronus.processing.module.filter import FilterType, LogicalFilterClause
...
class KeywordDocumentStore(BaseDocStore):
    """
...
class WeaviateDocStore(KeywordDocumentStore):
    """
